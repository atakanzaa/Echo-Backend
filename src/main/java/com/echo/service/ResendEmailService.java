...
public class ResendEmailService {
    ...
    public boolean send(String to, String subject, String htmlBody, String textBody) {
        ...
        if (!resend.isEnabled()) {
            log.debug("Resend disabled, simulating email delivery: subject={}", subject);
            return true;
        }
        ...
        log.debug("Email delivered via Resend: subject={}, emailId={}", subject, emailId);
        return true;
    }

    @SuppressWarnings("unused")
    public boolean sendFallback(String to, String subject, String htmlBody, String textBody, Throwable throwable) {
        log.error("Email delivery fallback triggered: subject={}", subject, throwable);
        return false;
    }
